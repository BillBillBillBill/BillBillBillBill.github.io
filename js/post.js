$(document).ready(function(){
    ...
    //***********************
    //**评论的代码也删掉哦***
    window.disqus_shortname = 'Bill'; // required: replace example with your forum shortname
    ...
    $('.entry a').each(function(index,element){
        ...
        if(href){
            if(href.indexOf('#') == 0){
            }else if ( href.indexOf('/') == 0 || href.toLowerCase().indexOf('BillBillBillBill.github.io')>-1 ){
